            ...
            <div className="flex justify-center items-center flex-col">
                ...
                <div className="max-w-5xl"> {/* Добавлен класс для контейнера */}
                            ...
                            <div className="flex flex-col lg:flex-row items-start lg:items-center">
                                <div className="lg:w-1/2 lg:mr-8">
                                    <h1 className="text-3xl font-bold text-blue-600 mb-4 max-[479px]:text-center m-1">Gull
                                        Med</h1>
                                    <p className="text-lg text-gray-700 leading-relaxed max-[479px]:text-center m-1">{t('h1')}</p>
                                </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-start lg:items-center">
                        <div className="w-full lg:mr-40 flex-grow">
                            <div className="bg-blue-600 text-white rounded-lg py-4 px-7 max-[479px]:m-1">
                                <h2 className="text-lg font-bold mb-2">{t('h2.header')}</h2>
                                <p className="text-sm">{t('h2.text')}</p>
                            </div>
                        </div>
                    ...
                    <div className='mt-10 mb-4'>
                        <h3 className='text-2xl font-bold text-blue-600 text-center mb-3'>{t('h3')}</h3>
